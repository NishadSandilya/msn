...
const Appointment2 = () => {
    ...
    return (
        <div className="appointment2">
            <p className='appointment2__title'>Book an Appointment</p>
            <div className="appointment2__form">
                <form
                ...
                >
                    <div className="details">
                        ...
                        <div className="details__appointment2-details">
                            <Controller
                                name="address"
                                defaultValue=""
                                control={control}
